    ...
    return (
        <>
            <div className="create_survey">
                {
                    surveyList.content[props.index].problemType === 0 ? <ViewSureveyQuestion key={props.index} index={props.index} /> :
                        surveyList.content[props.index].problemType === 1 ? <ViewSurveyChoice key={props.index} index={props.index} /> :
